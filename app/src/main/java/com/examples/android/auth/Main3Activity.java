...
//        });
        ...
        listView.setOnItemClickListener (new AdapterView.OnItemClickListener ( ) {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent updateDelete = new Intent (Main3Activity.this, updateDelete.class);
                Appliances appliances = (Appliances) adapterView.getItemAtPosition (i);
                final String namet = appliances.getItemName ( );
                final String typet = appliances.getType ( );
                final String schedulea = appliances.getSchedule ( );
                final String statuess = appliances.getStatus ( );
...
//                    Toast.makeText (getApplicationContext (),"asln",Toast.LENGTH_SHORT).show ();
                ...
                updateDelete.putExtra ("Item Name:", appliances.getItemName ( ));
                updateDelete.putExtra ("Place Name:", appliances.getType ( ));
                updateDelete.putExtra ("Status:", appliances.getStatus ( ));
                updateDelete.putExtra ("Schedule:", appliances.getSchedule ( ));
                updateDelete.putExtra ("key", appliances.getUserId ( ));
